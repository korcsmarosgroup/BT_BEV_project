# Quality control of microbe-host PPIs based on intrinsic protein regio (IPR) prediction
# Script is runable from the terminal
# Input files:
    # predicted microbe-host PPIs (output of the DMI.py script)
    # fasta file containing the human sequences (interacting human proteins)
    # path for the resource folder
    # pa
